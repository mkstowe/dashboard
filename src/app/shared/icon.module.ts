...
export class IconModule {
  ...
  constructor(
    ...
    .addSvgIcon("candle-active", this.setPath(`${this.path}/candle_active.svg`))
    .addSvgIcon("ceiling-light", this.setPath(`${this.path}/ceiling_light.svg`))
    .addSvgIcon("ceiling-light-active", this.setPath(`${this.path}/ceiling_light_active.svg`))
    ...
    .addSvgIcon("computer-active", this.setPath(`${this.path}/computer_active.svg`))
    ...
    .addSvgIcon("floor-lamp-active", this.setPath(`${this.path}/floor_lamp_active.svg`))
    ...
    .addSvgIcon("light-bulb-active", this.setPath(`${this.path}/light_bulb_active.svg`))
    ...
    .addSvgIcon("table-lamp-active", this.setPath(`${this.path}/table_lamp_active.svg`))
